...
.daybreak {
  ...
  height: 100%;
  overflow: hidden;
  background: linear-gradient(168deg, #12151e 0%, #0d1017 46%, #090c12 100%);
}
.bg-img {
...
.scrim {
  ...
  background: linear-gradient(to right,
    rgba(14, 17, 25, 0.97) 0%,
    rgba(14, 17, 25, 0.93) 30%,
    rgba(14, 17, 25, 0.55) 46%,
    rgba(14, 17, 25, 0) 62%);
}
...
.badge {
  ...
  background: rgba(201, 212, 232, 0.92);
  color: #16202c;
  font-size: 11px;
...
.brand-rule {
  ...
  height: 1px;
  width: 100%; /* 与徽章同宽 */
  background: linear-gradient(to right, rgba(201,212,232,0.85), rgba(201,212,232,0.1));
}
.title {
  margin: 16px 0 0;
  ...
  color: #c9d4e8;
  line-height: 1.05;
  text-shadow: 0 2px 16px rgba(201, 212, 232, 0.25);
}
...
.wave i {
  width: 3px;
  border-radius: 2px;
  background: linear-gradient(180deg, #8a94ab, #c9d4e8);
...
.lyr-sub[title]:hover { color: #c9d4e8; }
...
.mood-pop {
  ...
  border: 1px solid rgba(201, 212, 232, 0.18);
  border-radius: 14px;
  box-shadow: 0 16px 40px rgba(0, 0, 0, 0.5);
  z-index: 40;
}
.mp-title { font-size: 12px; color: #8a94ab; letter-spacing: 2px; margin-bottom: 10px; }
.mp-input {
  width: 100%;
  padding: 9px 12px;
  border-radius: 9px;
  border: 1px solid rgba(201, 212, 232, 0.25);
...
.mp-input:focus { border-color: #8a94ab; }
...
.mp-btn:hover { background: #c9d4e8; }
.mp-btn.ghost { background: transparent; color: #8a94ab; }
.mp-btn.ghost:hover { background: rgba(201, 212, 232, 0.1); }
...
.track {
  ...
  height: 5px;
  border-radius: 3px;
  background: rgba(201, 212, 232, 0.14);
  overflow: hidden;
}
.fill {
  height: 100%;
  border-radius: 3px;
  background: linear-gradient(90deg, #8a94ab, #c9d4e8);
}
.pct { font-size: 12px; color: #8a94ab; letter-spacing: 1px; }
.progress-cap {
  margin-top: 8px;
  font-size: 12px;
  color: #5c6474;
...
.tb-name { font-size: 14px; font-weight: 600; color: #e8a0bf; letter-spacing: 1px; }
.tb-mean { margin-top: 6px; font-size: 13px; color: #9aa3b5; line-height: 1.6; }
